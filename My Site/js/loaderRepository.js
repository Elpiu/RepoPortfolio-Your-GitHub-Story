window.onload= function () {
  ...
  */
  function createSubElementRepo(icon ,count, text){
    ...
    var strVar2="";
    strVar2 += "                <div class=\"d-inline-flex p-3\"><i class=\"fa "+icon+"\"><\/i>";
...
function createBoxElementPortfolioItem(id, data, userNameGithub){
    ...
    strVar += " <div class=\"portfolio-item mx-auto my-2 item-background1\" data-bs-toggle=\"modal\"";
    ...
    strVar += "  <div class=\"portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100 \">";
    strVar += "    <div class=\"portfolio-item-caption-content text-center text-white\"><i";
    ...
    strVar += "<div class=\"portfolio-modal modal fade \" id=\"portfolioModal"+id+"\" tabindex=\"-1\"";
    strVar += "    aria-labelledby=\"portfolioModal"+id+"\" aria-hidden=\"true\">";
    strVar += "    <div class=\"modal-dialog modal-xl\">";
    strVar += "        <div class=\"modal-content\">";
    strVar += "            <div class=\"modal-header border-0\"><button class=\"btn-close\" type=\"button\"";
    strVar += "                    data-bs-dismiss=\"modal\" aria-label=\"Close\"><\/button><\/div>";
    ...
    strVar += "                        <div id=\""+containerID+"\" class=\"col-lg-8\">";
    strVar += "                            <button class=\"btn btn-primary\" data-bs-dismiss=\"modal\">";
    strVar += "                                <i class=\"fas fa-times\"><\/i>";
    strVar += "                                Go Back";
    strVar += "                            <\/button>";
    strVar += "";
    strVar += "                            <button class=\"btn btn-primary\" data-bs-dismiss=\"modal\"";
    strVar += "                                onclick=\"window.open('"+repoURL+"','_blank')\" ";
